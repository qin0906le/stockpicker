...
const STOCK_DATA = {
  asOf: "Q1 2026",
  pricesAsOf: "late May – 11 June 2026",
  markets: [
    {
      id: "US",
      name: "United States",
...
const TRADE_LEVELS = {
  US: {
    NVDA: { cur: "$", price: 200.42, date: "10 Jun 2026", buyLo: 186, buyHi: 200, stop: 154, riskPct: 20, target: 299 },
    TSM: { cur: "$", price: 427.92, date: "10 Jun 2026", buyLo: 400, buyHi: 430, stop: 345, riskPct: 17, target: 470 },
    AVGO: { cur: "$", price: 372.1, date: "10 Jun 2026", buyLo: 345, buyHi: 370, stop: 286, riskPct: 20, target: 500 },
    CRWD: { cur: "$", price: 642.8, date: "10 Jun 2026", buyLo: 600, buyHi: 645, stop: 510, riskPct: 18, target: 710 },
    PANW: { cur: "$", price: 265.43, date: "10 Jun 2026", buyLo: 247, buyHi: 265, stop: 212, riskPct: 17, target: 305 },
    ZS: { cur: "$", price: 125.82, date: "11 Jun 2026", buyLo: 117, buyHi: 126, stop: 97.2, riskPct: 20, target: 194 },
    LLY: { cur: "$", price: 1144.68, date: "9 Jun 2026", buyLo: 1065, buyHi: 1145, stop: 905, riskPct: 18, target: 1215 },
    ISRG: { cur: "$", price: 412.02, date: "10 Jun 2026", buyLo: 385, buyHi: 410, stop: 330, riskPct: 17, target: 570 },
    ABBV: { cur: "$", price: 225.42, date: "9 Jun 2026", buyLo: 210, buyHi: 225, stop: 185, riskPct: 15, target: 254 },
    V: { cur: "$", price: 322.96, date: "10 Jun 2026", buyLo: 300, buyHi: 325, stop: 272, riskPct: 13, target: 400 },
    MA: { cur: "$", price: 488.53, date: "10 Jun 2026", buyLo: 455, buyHi: 490, stop: 410, riskPct: 13, target: 655 },
    AXP: { cur: "$", price: 318.38, date: "10 Jun 2026", buyLo: 296, buyHi: 320, stop: 256, riskPct: 17, target: 355 },
    XOM: { cur: "$", price: 152.15, date: "11 Jun 2026", buyLo: 141, buyHi: 152, stop: 125, riskPct: 15, target: 165 },
    CEG: { cur: "$", price: 244.04, date: "11 Jun 2026", buyLo: 227, buyHi: 244, stop: 195, riskPct: 17, target: 365 },
    CVX: { cur: "$", price: 189.8, date: "10 Jun 2026", buyLo: 177, buyHi: 190, stop: 158, riskPct: 14, target: 217 },
  },
  SG: {
    DBS: { cur: "S$", price: 62.01, date: "11 Jun 2026", buyLo: 57.7, buyHi: 62, stop: 52.1, riskPct: 13, target: 64.2 },
    OCBC: { cur: "S$", price: 23.4, date: "11 Jun 2026", buyLo: 21.8, buyHi: 23.4, stop: 19.66, riskPct: 13, target: 23.9 },
    UOB: { cur: "S$", price: 38.26, date: "9 Jun 2026", buyLo: 35.6, buyHi: 38.3, stop: 32.1, riskPct: 13, target: 38.2 },
    CICT: { cur: "S$", price: 2.27, date: "1 Jun 2026", buyLo: 2.11, buyHi: 2.27, stop: 1.91, riskPct: 13, target: 2.7 },
    KDCREIT: { cur: "S$", price: 2.26, date: "mid-Jun 2026", buyLo: 2.1, buyHi: 2.26, stop: 1.85, riskPct: 15, target: 2.54 },
    CLAR: { cur: "S$", price: 2.51, date: "11 Jun 2026", buyLo: 2.33, buyHi: 2.51, stop: 2.08, riskPct: 14, target: 3.19 },
    STENG: { cur: "S$", price: 10.88, date: "5 Jun 2026", buyLo: 10.12, buyHi: 10.88, stop: 8.72, riskPct: 17, target: 12.18 },
    YZJ: { cur: "S$", price: 4.31, date: "early Jun 2026", buyLo: 4.01, buyHi: 4.31, stop: 3.45, riskPct: 17, target: 4.65 },
    SATS: { cur: "S$", price: 3.88, date: "11 Jun 2026", buyLo: 3.61, buyHi: 3.88, stop: 3.11, riskPct: 17, target: 4.44 },
    SINGTEL: { cur: "S$", price: 4.24, date: "11 Jun 2026", buyLo: 3.94, buyHi: 4.24, stop: 3.52, riskPct: 14, target: 5.18 },
    IFAST: { cur: "S$", price: 8.7, date: "9 Jun 2026", buyLo: 8.09, buyHi: 8.7, stop: 6.97, riskPct: 17, target: 11.97 },
    VENTURE: { cur: "S$", price: 17.88, date: "early Jun 2026", buyLo: 16.63, buyHi: 17.88, stop: 14.67, riskPct: 15, target: 21.8 },
    SHENG: { cur: "S$", price: 3.14, date: "11 Jun 2026", buyLo: 2.92, buyHi: 3.14, stop: 2.64, riskPct: 13, target: 3.26 },
    RAFFLES: { cur: "S$", price: 0.99, date: "11 Jun 2026", buyLo: 0.92, buyHi: 0.99, stop: 0.81, riskPct: 15, target: 1.18 },
    DFI: { cur: "US$", price: 4.28, date: "early Jun 2026", buyLo: 3.98, buyHi: 4.28, stop: 3.39, riskPct: 18, target: 4.58, note: "DFI trades in USD on SGX" },
  },
  MY: {
    PBBANK: { cur: "RM", price: 4.74, date: "3 Jun 2026", buyLo: 4.41, buyHi: 4.74, stop: 4.07, riskPct: 11, target: 5.11 },
    MAYBANK: { cur: "RM", price: 10.68, date: "10 Jun 2026", buyLo: 9.93, buyHi: 10.68, stop: 9.17, riskPct: 11, target: 12.2 },
    CIMB: { cur: "RM", price: 7.39, date: "5 Jun 2026", buyLo: 6.87, buyHi: 7.39, stop: 6.13, riskPct: 14, target: 9.05 },
    TENAGA: { cur: "RM", price: 14.22, date: "10 Jun 2026", buyLo: 13.22, buyHi: 14.22, stop: 11.94, riskPct: 13, target: 15.98 },
    YTLPOWR: { cur: "RM", price: 4.05, date: "14 May 2026", buyLo: 3.77, buyHi: 4.05, stop: 3.17, riskPct: 19, target: 4.53, note: "Quote from mid-May 2026 — verify current price" },
    PETGAS: { cur: "RM", price: 17.1, date: "early Jun 2026", buyLo: 15.9, buyHi: 17.1, stop: 14.52, riskPct: 12, target: 18.75 },
    FRONTKN: { cur: "RM", price: 4.1, date: "early Jun 2026", buyLo: 3.81, buyHi: 4.1, stop: 3.28, riskPct: 17, target: 4.86 },
    VITROX: { cur: "RM", price: 6.85, date: "early Jun 2026", buyLo: 6.37, buyHi: 6.85, stop: 5.42, riskPct: 18, target: 5.08 },
    INARI: { cur: "RM", price: 2.36, date: "3 Jun 2026", buyLo: 2.19, buyHi: 2.36, stop: 1.84, riskPct: 19, target: 1.86 },
    "99SMART": { cur: "RM", price: 3.3, date: "2 Jun 2026", buyLo: 3.07, buyHi: 3.3, stop: 2.74, riskPct: 14, target: 3.97 },
    MRDIY: { cur: "RM", price: 1.67, date: "early Jun 2026", buyLo: 1.55, buyHi: 1.67, stop: 1.35, riskPct: 16, target: 2.2 },
    QL: { cur: "RM", price: 3.95, date: "early Jun 2026", buyLo: 3.67, buyHi: 3.95, stop: 3.31, riskPct: 13, target: 4.21 },
    IHH: { cur: "RM", price: 9.03, date: "Mar–May 2026", buyLo: 8.4, buyHi: 9.03, stop: 7.58, riskPct: 13, target: 9.86, note: "Most recent reliable quote is from spring 2026 — verify current price" },
    KPJ: { cur: "RM", price: 3.39, date: "early Jun 2026", buyLo: 3.15, buyHi: 3.39, stop: 2.75, riskPct: 16, target: 3.17 },
