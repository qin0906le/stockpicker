          ...
          stocks: [
            {
              ...
              metrics: {
                ...
                valuation: "P/E ~11–12, P/B ~1.8, yield ~5.5–6% incl. capital return",
              },
          ...
          stocks: [
            ...
            },
            {
              ...
              metrics: {
                ...
                valuation: "P/E ~13–15, yield ~6% — paid to wait",
              },
          ...
          stocks: [
            ...
            },
            {
              ...
              metrics: {
                ...
                roe: "~14–18%",
                balanceSheet: "Net cash",
                valuation: "P/E ~35–40 — expensive, as always for this name",
              },
...
const TRADE_LEVELS = {
  US: {
    NVDA: { ref: "$200 (10 Jun 2026)", buy: "$186 – $200", stop: "$155 (≈ -20%)" },
    TSM: { ref: "$430 (10 Jun 2026)", buy: "$400 – $430", stop: "$345 (≈ -17%)" },
    AVGO: { ref: "$370 (10 Jun 2026)", buy: "$345 – $370", stop: "$287 (≈ -20%)" },
    CRWD: { ref: "$645 (10 Jun 2026)", buy: "$600 – $645", stop: "$510 (≈ -18%)" },
    PANW: { ref: "$265 (10 Jun 2026)", buy: "$247 – $265", stop: "$213 (≈ -17%)" },
    ZS: { ref: "$125 (10 Jun 2026)", buy: "$116 – $125", stop: "$100 (≈ -17%)" },
    LLY: { ref: "$1,145 (9 Jun 2026)", buy: "$1,065 – $1,145", stop: "$905 (≈ -18%)" },
    ISRG: { ref: "$410 (10 Jun 2026)", buy: "$385 – $410", stop: "$330 (≈ -17%)" },
    ABBV: { ref: "$225 (9 Jun 2026)", buy: "$210 – $225", stop: "$185 (≈ -15%)" },
    V: { ref: "$325 (10 Jun 2026)", buy: "$300 – $325", stop: "$271 (≈ -13%)" },
    MA: { ref: "$490 (10 Jun 2026)", buy: "$455 – $490", stop: "$410 (≈ -13%)" },
    AXP: { ref: "$320 (10 Jun 2026)", buy: "$296 – $320", stop: "$255 (≈ -17%)" },
    XOM: { ref: "$152 (11 Jun 2026)", buy: "$141 – $152", stop: "$125 (≈ -15%)" },
    CEG: { ref: "$244 (11 Jun 2026)", buy: "$227 – $244", stop: "$195 (≈ -17%)" },
    CVX: { ref: "$190 (10 Jun 2026)", buy: "$177 – $190", stop: "$158 (≈ -14%)" },
  },
  SG: {
    DBS: { ref: "S$62.0 (11 Jun 2026)", buy: "S$57.7 – S$62.0", stop: "S$52.1 (≈ -13%)" },
    OCBC: { ref: "S$23.4 (11 Jun 2026)", buy: "S$21.8 – S$23.4", stop: "S$19.65 (≈ -13%)" },
    UOB: { ref: "S$38.3 (9 Jun 2026)", buy: "S$35.6 – S$38.3", stop: "S$32.1 (≈ -13%)" },
    CICT: { ref: "S$2.27 (1 Jun 2026)", buy: "S$2.11 – S$2.27", stop: "S$1.91 (≈ -13%)" },
    KDCREIT: { ref: "S$2.26 (mid-Jun 2026)", buy: "S$2.10 – S$2.26", stop: "S$1.85 (≈ -15%)" },
    CLAR: { ref: "S$2.51 (11 Jun 2026)", buy: "S$2.33 – S$2.51", stop: "S$2.08 (≈ -14%)" },
    STENG: { ref: "S$10.88 (5 Jun 2026)", buy: "S$10.12 – S$10.88", stop: "S$8.71 (≈ -17%)" },
    YZJ: { ref: "S$3.75 (25 May 2026)", buy: "S$3.49 – S$3.75", stop: "S$3.00 (≈ -17%)", note: "Quote from late May 2026 — verify current price" },
    SATS: { ref: "S$3.88 (11 Jun 2026)", buy: "S$3.61 – S$3.88", stop: "S$3.11 (≈ -17%)" },
    SINGTEL: { ref: "S$4.24 (11 Jun 2026)", buy: "S$3.94 – S$4.24", stop: "S$3.52 (≈ -14%)" },
    IFAST: { ref: "S$8.70 (9 Jun 2026)", buy: "S$8.09 – S$8.70", stop: "S$6.97 (≈ -17%)" },
    VENTURE: { ref: "S$17.88 (early Jun 2026)", buy: "S$16.63 – S$17.88", stop: "S$14.67 (≈ -15%)" },
    SHENG: { ref: "S$3.14 (11 Jun 2026)", buy: "S$2.92 – S$3.14", stop: "S$2.64 (≈ -13%)" },
    RAFFLES: { ref: "S$0.99 (11 Jun 2026)", buy: "S$0.92 – S$0.99", stop: "S$0.81 (≈ -15%)" },
    DFI: { ref: "US$4.28 (early Jun 2026)", buy: "US$3.98 – US$4.28", stop: "US$3.39 (≈ -18%)", note: "DFI trades in USD on SGX" },
  },
  MY: {
    PBBANK: { ref: "RM4.74 (3 Jun 2026)", buy: "RM4.41 – RM4.74", stop: "RM4.07 (≈ -11%)" },
    MAYBANK: { ref: "RM10.68 (10 Jun 2026)", buy: "RM9.93 – RM10.68", stop: "RM9.17 (≈ -11%)" },
    CIMB: { ref: "RM7.39 (5 Jun 2026)", buy: "RM6.87 – RM7.39", stop: "RM6.13 (≈ -14%)" },
    TENAGA: { ref: "RM14.22 (10 Jun 2026)", buy: "RM13.22 – RM14.22", stop: "RM11.94 (≈ -13%)" },
    YTLPOWR: { ref: "RM4.05 (14 May 2026)", buy: "RM3.77 – RM4.05", stop: "RM3.17 (≈ -19%)", note: "Quote from mid-May 2026 — verify current price" },
    PETGAS: { ref: "RM17.10 (early Jun 2026)", buy: "RM15.90 – RM17.10", stop: "RM14.52 (≈ -12%)" },
    FRONTKN: { ref: "RM4.10 (early Jun 2026)", buy: "RM3.81 – RM4.10", stop: "RM3.28 (≈ -17%)" },
    VITROX: { ref: "RM6.85 (early Jun 2026)", buy: "RM6.37 – RM6.85", stop: "RM5.42 (≈ -18%)" },
    INARI: { ref: "RM2.36 (3 Jun 2026)", buy: "RM2.19 – RM2.36", stop: "RM1.84 (≈ -19%)" },
    "99SMART": { ref: "RM3.30 (2 Jun 2026)", buy: "RM3.07 – RM3.30", stop: "RM2.74 (≈ -14%)" },
    MRDIY: { ref: "RM1.67 (early Jun 2026)", buy: "RM1.55 – RM1.67", stop: "RM1.35 (≈ -16%)" },
    QL: { ref: "RM3.95 (early Jun 2026)", buy: "RM3.67 – RM3.95", stop: "RM3.32 (≈ -13%)" },
    IHH: { ref: "RM9.03 (Mar–May 2026)", buy: "RM8.40 – RM9.03", stop: "RM7.58 (≈ -13%)", note: "Most recent reliable quote is from spring 2026 — verify current price" },
    KPJ: { ref: "RM3.39 (early Jun 2026)", buy: "RM3.15 – RM3.39", stop: "RM2.75 (≈ -16%)" },
    HARTA: { ref: "RM1.34 (13 May 2026)", buy: "RM1.25 – RM1.34", stop: "RM1.03 (≈ -20%)", note: "High-risk cyclical — respect the stop strictly; quote from mid-May 2026" },
  },
};
